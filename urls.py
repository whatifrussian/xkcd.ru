...
(r'^edit/(?P<comics_id>\d+)/$', 'comics.views.edit'),
...
(r'^transcript_clear/(?P<comics_id>\d+)/$', 'transcript.views.clear_unapproved'),
(r'^transcription/(?P<comics_id>\d+)/$', 'transcript.views.show_transcription'),
